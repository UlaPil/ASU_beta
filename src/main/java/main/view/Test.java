...
public class Test extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        CardDisplay card2 = new CardDisplay(new Card(Symbol.plusTwo, Color.green));
        ...
        CardDisplay card7 = new CardDisplay(new Card(Symbol.nine, Color.yellow));
        CardDisplay card8 = new CardDisplay(new Card(Symbol.block, Color.red));
        CardDisplay card9 = new CardDisplay(new Card(Symbol.reverse, Color.green));
